...
namespace IP2LocationDesctopApp
{
     class Program
    {
        ...
        static void Main()
        {
            ...
            //Console.WriteLine(prog.QueryIP2Location("8.8.8.8"));
         ...
         public string QueryIP2Location(string strIPAddress)
        {
            ...
            try
            {
                if (strIPAddress != "")
                {
                    ...
                    oIP2Location.IPDatabasePath = @"H:\Visual Studio IDE versions\WorkspaceCSharpProjects2022\IP2LocationDesctopApp\sample.bin.db25\IP-COUNTRY-REGION-CITY-LATITUDE-LONGITUDE-ZIPCODE-TIMEZONE-ISP-DOMAIN-NETSPEED-AREACODE-WEATHER-MOBILE-ELEVATION-USAGETYPE-ADDRESSTYPE-CATEGORY-SAMPLE.BIN";
